...
const options = {
  ...
  hAxis: { textStyle: { color: "#ffffff", fontName: "Retro", fontSize: 20 } },
  vAxis: { textStyle: { color: "#ffffff", fontName: "Retro", fontSize: 20 } },
  legend: { textStyle: { color: "#ffffff", fontName: "Retro", fontSize: 22 } },
  pieSliceTextStyle: { color: "#ffffff", fontName: "Retro" },
...
const Main = () => {
  ...
  return (
    <div className="flex flex-col text-white">
      ...
      <div className="mx-10 md:mx-[200px] my-10 flex justify-center min-h-[200px] items-center gap-3">
        <a
          href="https://app.icpswap.com/swap/?input=ryjl3-tyaaa-aaaaa-aaaba-cai&output=eayyd-iiaaa-aaaah-adtea-cai"
          target="_blank"
          rel="noopener noreferrer"
        >
          <button className="bg-blue-500 text-xl rounded-2xl px-10 py-3 ">
            Swap iDOGE
          </button>
        </a>
        <a
          href="https://twitter.com/idoge_icp"
          target="_blank"
          rel="noopener noreferrer"
        >
          <button className="bg-blue-500 text-xl  rounded-2xl px-10 py-3">
      ...
      <div className="flex justify-center my-10">
        <h3 className="font-bold text-2xl bg-blue-400 p-5  bg-opacity-20 rounded-lg">
          Maximum supply- <span className="font-normal text-xl">1,000,000</span>
        </h3>
      </div>

      <div className=" px-0 sm:px-4 ss:py-8 py-0 bg-blue-400 bg-opacity-20 my-5 mx-10 md:mx-[200px] rounded-2xl">
        <h3 className="text-center text-3xl">Tokenomics</h3>
        <Chart
          chartType="PieChart"
          data={data}
          options={options}
